                    ...
                    <div class="handle">
                        <div class="card my-0">
                            <div class="d-flex align-items-center">
                                <img src="img/pp2.jpg" alt="burak" class="border-1 profile-photo s3 me-2">
                                <div class="me-5">
                                    <h6 class="mb-0 fs-7 text-name">Emir Tolluoğlu</h5>
                                        <p class="fs-7 mb-0 text-name">9 Ortak Arkadaş</p>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <div style="outline: none;"
                                    class="btn bg-main text-name fw-bold w-100 my-2 p-1 border-0">Mesaj Gönder!</div>
                    ...
                    <div class="card border border-secondary">
                        ...
                        <img src="img/pp2.jpg" alt="burak" class="border-1 profile-photo s5">
                            ...
                            <div class="mx-auto">
                                ...
                                <i class="fa fa-certificate"></i><p class="d-inline ms-2 text-name">120 Xp</p>
                            </div>
                            <div>
